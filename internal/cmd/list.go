...
func init() {
	...
	readyCmd.Flags().StringVarP(&listFlags.Type, "type", "t", "", "Filter by type (task|bug|feature|story|investigation|epic|chore)")
	...
	blockedCmd.Flags().StringVarP(&listFlags.Type, "type", "t", "", "Filter by type (task|bug|feature|story|investigation|epic|chore)")
	...
	closedCmd.Flags().StringVarP(&listFlags.Type, "type", "t", "", "Filter by type (task|bug|feature|story|investigation|epic|chore)")
